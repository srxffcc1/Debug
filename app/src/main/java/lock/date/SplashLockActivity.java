 ...
 */
public class SplashLockActivity extends Activity implements SplashADListener {
...
//      checkAndRequestPermission();
      ...
      fetchSplashAD(this, container, skipView, "1107995123", "5050945869406990", this, 0);
    }
  }
...
//  }
  ...
  public void onNoAD(AdError error) {
    ...
    handler.postDelayed(new Runnable() {
      @Override
      public void run() {
//        SplashLockActivity.this.startActivity(new Intent(SplashLockActivity.this, DemoListActivity.class));
