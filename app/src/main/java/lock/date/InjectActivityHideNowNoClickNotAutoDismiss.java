...
public class InjectActivityHideNowNoClickNotAutoDismiss {
    private static final InjectActivityHideNowNoClickNotAutoDismiss instance = new InjectActivityHideNowNoClickNotAutoDismiss();
    private Activity activity;
    private int inittimes = 0;


    private InjectActivityHideNowNoClickNotAutoDismiss() {

    }

    public static InjectActivityHideNowNoClickNotAutoDismiss getInstance() {
        return instance;
    }

    public InjectActivityHideNowNoClickNotAutoDismiss setActivity(Activity activity) {
        this.activity = activity;
        return instance;
    }

    public InjectActivityHideNowNoClickNotAutoDismiss init() {
        inittimes = 0;
        return instance;
    }
    ...
    private void onCreateStartToReplaceSetContentViewRightTop(boolean needback, boolean needfloat, boolean needdismiss) {
        ...
        DragLayoutClickOne DragLayoutClickOne = new DragLayoutClickOne(activity);
        DragLayoutClickOne.setBackgroundColor(Color.parseColor("#00000000"));
        DragLayoutClickOne.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        ...
        if (needfloat) {
            FloatingViewNoSensorNoAutoDismiss FloatingViewNoSensorNoAutoDismiss = new FloatingViewNoSensorNoAutoDismiss(activity);
            FloatingViewNoSensorNoAutoDismiss.setId(0x7f07000b);
            FloatingViewNoSensorNoAutoDismiss.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    start3dmWeb(v);
                }
            });
            FloatingViewNoSensorNoAutoDismiss.setImageDrawable(ImageUtilz.loadImageFromAsserts(activity, "splash23dm.png"));
            ...
            FloatingViewNoSensorNoAutoDismiss.setLayoutParams(relayoutParams);
            FloatingViewNoSensorNoAutoDismiss.setScaleType(ImageView.ScaleType.FIT_CENTER);
            FloatingViewNoSensorNoAutoDismiss.setVisibility(View.INVISIBLE);
            DragLayoutClickOne.addView(FloatingViewNoSensorNoAutoDismiss);
        }
        ...
        parent.addView(DragLayoutClickOne);
    ...
    private void onCreateStartToReplaceSetContentViewLeftTop(boolean needback, boolean needfloat, boolean needdismiss) {
        ...
        if (needfloat) {
            ...
            FloatingViewNoSensorNoAutoDismiss.setImageDrawable(ImageUtilz.loadImageFromAsserts(activity, "splash23dm.png"));
            FloatingViewNoSensorNoAutoDismiss.setLayoutParams(new LinearLayout.LayoutParams(430, 175));
            FloatingViewNoSensorNoAutoDismiss.setScaleType(ImageView.ScaleType.FIT_CENTER);
            FloatingViewNoSensorNoAutoDismiss.setVisibility(View.INVISIBLE);
            DragLayoutClickOne.addView(FloatingViewNoSensorNoAutoDismiss);
        }
