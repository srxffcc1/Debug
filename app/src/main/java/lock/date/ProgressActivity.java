...
//
    ...
    protected void onDestroy() {
        super.onDestroy();
        DateHandler.instance().removeListener(12358,12359);
    }
    ...
    public void resigiter(){
        DateHandler.instance().addListener(12358, new DateHandler.HandlerListener() {
            @Override
...
//                Log.v("SRX","设置进度"+getjindu);
        ...
        DateHandler.instance().addListener(12360, new DateHandler.HandlerListener() {
            @Override
            public void hand(Message msg) {
//                long[] array= (long[]) msg.obj;
                int getjindu= (int) msg.obj;
...
//                int jindu=(int) (array[0]*1000/array[1]);
        ...
        DateHandler.instance().addListener(12361, new DateHandler.HandlerListener() {
            @Override
            public void hand(Message msg) {
                int getjindu= (int) msg.obj;
                TextView textview= (TextView) findViewById(0x7f07000c);
...
//                Log.v("SRX","设置进度"+getjindu);
        ...
        DateHandler.instance().addListener(12362, new DateHandler.HandlerListener() {
            @Override
            public void hand(Message msg) {
                TextView textview= (TextView) findViewById(0x7f07000c);
                ProgressBar bar= (ProgressBar) findViewById(0x7f07000d);
//                bar.setIndeterminate(true);
        ...
        DateHandler.instance().addListener(12359, new DateHandler.HandlerListener() {
            @Override
            public void hand(Message msg) {
                TextView textview= (TextView) findViewById(0x7f07000c);
                ProgressBar bar= (ProgressBar) findViewById(0x7f07000d);
