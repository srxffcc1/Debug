...
public class FloatingViewNoSensorNoAutoDismiss extends ImageView implements ViewTreeObserver.OnGlobalLayoutListener{//, ScrollDirectionListener.ScrollViewListener {
    private final static String TAQ = FloatingViewNoSensorNoAutoDismiss.class.getSimpleName();
    ...
    public FloatingViewNoSensorNoAutoDismiss(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    public FloatingViewNoSensorNoAutoDismiss(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                @Override
//                public void run() {
//                    FloatingViewNoSensorNoAutoDismiss.super.setVisibility(View.INVISIBLE);
//
//                }
